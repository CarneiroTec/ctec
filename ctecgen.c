...
/* CTEC module system - PSR-4 style namespacing */
                            ...
                            int can_add_underscore)
{
    ...
    if (!sym->c) {
        ...
        /* CTEC module system: prefix symbol with module name */
 ...
 push_tokc:
    ...
    tok_identifier:
        ...
        if (t < TOK_UIDENT)
            expect("identifier");
        s = sym_find(t);
        /* CTEC module system: try module.symbol resolution */
        if (!s && tok == '.') {
        ...
        if (!parse_btype(&btype, &ad)) {
            ...
            if (tok >= TOK_UIDENT) {
               /* special test for old K&R protos without explicit int
                ...
                /* CTEC: if we're inside a module block and hit '}', just break */
