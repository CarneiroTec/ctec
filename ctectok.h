...
/* ------------------------------------------------------------------ */
/* Atributos e construções do compilador (atributos, typeof, alignof)  */
/* ------------------------------------------------------------------ */
     DEF(TOK_ALIGNOF, "ObtenhaAlinhamento")
     DEF(TOK_ASM, "Montador")
     DEF(TOK_ATTRIBUTE, "Atributo")
     DEF(TOK_LABEL, "Rótulo")
     DEF(TOK_SIZEOF, "Meça")
